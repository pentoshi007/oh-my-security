    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="mb-8">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-all duration-300 hover:scale-105 border border-gray-200"
          >
        ...
        {error ? (
          <div className="text-center">
            <div className="bg-red-50 border border-red-200 rounded-lg p-8 max-w-md mx-auto">
              <h2 className="text-xl font-semibold text-red-600 mb-4">Error Loading Archive</h2>
          ...
          <div className="text-center">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 max-w-md mx-auto">
              ...
              <p className="text-gray-500">Content archive is currently empty. Check back later!</p>
            </div>
          </div>
        ) : (
